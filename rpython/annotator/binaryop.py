...
class __extend__(pairtype(SomeObject, SomeObject)):
    ...
    def inplace_add(objs): return pair(objs[0], objs[1]).add()
    def inplace_sub(objs): return pair(objs[0], objs[1]).sub()
    def inplace_mul(objs): return pair(objs[0], objs[1]).mul()
    def inplace_truediv(objs): return pair(objs[0], objs[1]).truediv()
    def inplace_floordiv(objs): return pair(objs[0], objs[1]).floordiv()
    def inplace_div(objs): return pair(objs[0], objs[1]).div()
    def inplace_mod(objs): return pair(objs[0], objs[1]).mod()
    def inplace_lshift(objs): return pair(objs[0], objs[1]).lshift()
    def inplace_rshift(objs): return pair(objs[0], objs[1]).rshift()
    def inplace_and(objs): return pair(objs[0], objs[1]).and_()
    def inplace_or(objs): return pair(objs[0], objs[1]).or_()
    def inplace_xor(objs): return pair(objs[0], objs[1]).xor()
